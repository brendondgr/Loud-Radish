...
*Last updated: 2026-08-15 (the multi-mode expansion — five plans, and D-020)*
...
| Multi-mode interface | 🔧 Specified in `design-system.md`; implementation is [Plan 2](plans/multi-mode-ui-implementation.md) |
| Recorded transcription mode | ⬜ Not started — [Plan 3](plans/recorded-transcription.md) |
| Window recording mode | ⬜ Not started — [Plan 4](plans/window-recording-transcription.md) |
| Desktop integration | ⬜ Not started, partly blocked — [Plan 5](plans/system-integration.md) |
