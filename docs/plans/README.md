...
| [capture-hardening.md](capture-hardening.md) | Executing the research findings: caps-driven geometry, runtime assertions, the measurement sidecar, monitor-pane reconciliation, hardware AV1 encoding, and per-window audio | **In progress (0 / 7)** |
