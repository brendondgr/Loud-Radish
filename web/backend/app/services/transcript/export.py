...
* **Markdown** — transcript plus outline plus glossary plus the conversation. The most useful format
  for later study, and the one that justifies keeping all four in one file.
